//===-- ECE2031InstrInfo.h - ECE2031 Instruction Information --------*- C++
//-*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file contains the ECE2031 implementation of the TargetInstrInfo class.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_ECE2031_ECE2031INSTRINFO_H
#define LLVM_LIB_TARGET_ECE2031_ECE2031INSTRINFO_H
...
class ECE2031InstrInfo : public ECE2031GenInstrInfo {
  const ECE2031RegisterInfo RI;
